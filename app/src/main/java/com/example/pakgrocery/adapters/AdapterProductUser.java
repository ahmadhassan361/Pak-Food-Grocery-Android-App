...
import com.example.pakgrocery.FilterProductUser;
...
public class AdapterProductUser extends RecyclerView.Adapter<AdapterProductUser.HolderProductUser> implements Filterable
{
    ...
    public AdapterProductUser(Context context, ArrayList<ModelProducts> productList) {
    ...
    public void onBindViewHolder(@NonNull HolderProductUser holder, int position)
    {
        ...
        String productIcon = modelProducts.getProductIconIv();
        ...
        try {
            Picasso.get().load(productIcon).placeholder(R.drawable.ic_product_add).into(holder.productIconIv);
        }
        catch (Exception e)
        {
        ...
        holder.addToCartTv.setOnClickListener(new View.OnClickListener() {
            ...
            {//add product to cart
                showQuantityDialogue(modelProducts);
    ...
    private void showQuantityDialogue(ModelProducts modelProducts)
    {
        //inflate layout to dialogue
        View view = LayoutInflater.from(context).inflate(R.layout.dialogue_quantity,null);
        //init layout views
        ImageView productIv = view.findViewById(R.id.productIv);
        final TextView titleTv = view.findViewById(R.id.titleTv);
        TextView pQuntityTv = view.findViewById(R.id.pQuntityTv);
        ...
        try
        {
            Picasso.get().load(iconIv).placeholder(R.drawable.ic_baseline_shopping_cart_24).into(productIv);
        ...
        pQuntityTv.setText(""+productQuantity);
        ...
        //decrement quantity of product,only if quantity greater than one
